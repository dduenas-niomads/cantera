            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    ...
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h3 class="mb-0">Resumen de RUCS</h3>
                        </div>
                        <div class="col-6 text-right">
                            <a href="{{ route('taxes.create') }}" class="btn btn btn-default">Nuevo RUC</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive-sm">
                        <table class="myTable align-items-center table-bordered table-hover table-sm" id="carListDataTable">
                            <thead class="thead-dark">
                                <tr>
                                    <th scope="col" class="thTaxationLeft">Tipo de RUC</th>
                                    <th scope="col" class="thTaxationMiddle">N° Documento</th>
                                    <th scope="col" class="thTaxationMiddle">Razón social</th>
                                    <th scope="col" class="thTaxationMiddle">Descripción</th>
                                    <th scope="col" class="thTaxationMiddle">Máximo de emisión</th>
...
<script>
                ...
                {'data':   function (data) {
                    return '<div class="dropdown">' +
                            ...
                            '<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">' +
                                '<a class="dropdown-item" href="/taxes/' + data.id + '/edit">Información general</a>' +
                                '<a class="dropdown-item" href="#">Reporte de emisión</a>' +
                                '<a class="dropdown-item" href="#" onclick="deleteTax(' + data.id + ');">Eliminar RUC</a>' +
                            '</div>' +
                        '</div>';
                }, "orderable": false},
            ],
    ...
    function productStatus() {
        ...
        if (status != null) {
            window.location.replace('/taxes?status=' + status.value);
        }
    }
