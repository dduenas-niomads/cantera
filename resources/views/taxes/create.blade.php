			...
			<div class="card shadow">
				<div class="card-header border-0">
					<div class="row align-items-center">
						<div class="col-12">
							<h3 class="mb-0">Nuevo ingreso de RUC - Datos generales</h3>
						</div>
					</div>
				</div>
				<hr>
				<div class="col-12">
					<form method="post" action="{{ route('taxes.store') }}" autocomplete="off" id="storeForm">
						@csrf
						@method('post')
						<div class="row">
							<div class="col-md-6">
								...
								<div class="col-md-12">
									<div class="text-center">
										<button type="button" onclick="submitForm('storeForm');" 
											class="btn btn-success mt-4">{{ __('Registrar RUC') }}</button>
									</div>
									<br>
								</div>
							</div>
