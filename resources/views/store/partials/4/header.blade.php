...
<header id="wrap-header" class="color-inher">
    ...
    <div class="">
        <div class="container background4">
                                ...
                                <div class="container1-fluid">
                                    <div class="navbar-header row">
                                        <div class="col-xs-12 mobileBanner" style="padding-top: 1.5rem; text-align: center;">
                                            ...
                                            <a class="color-blue" href="/store/cars" style="padding-right: 1rem;"><b class="titleMobile">Vehículos</b></a>
                                    ...
                                    <div class="navbar-collapse">
                                        <div class="col-md-4">
                                            <div class="col-md-4">
                                                <a href="/">
                                                    <img src="/store/images/logo_web.png" alt="JC Ugarte" width="250px" style="padding-top: 5px">
                                                </a>
                                            </div>
                                            <div class="col-md-8">
                                                <h3>
			...
			@include('store.partials.4.search_light')
        </div>
    </div>
</header>