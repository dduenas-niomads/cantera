    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group{{ $errors->has('soat_code') ? ' has-danger' : '' }}">
                ...
                <input type="text" maxlength="50" name="details[soat_code]" id="input-soat_code" class="form-control" placeholder="{{ __('Ingrese póliza de SOAT') }}" value="" autofocus>
            </div>
            ...
            <div class="form-group{{ $errors->has('sat_taxes') ? ' has-danger' : '' }}">
                ...
                <select name="details[sat_taxes]" id="input-sat_taxes" class="form-control {{ $errors->has('sat_taxes') ? ' is-invalid' : '' }}" autofocus>
                    <option value="0">PENDIENTE</option>
                    <option value="1">PAGADO</option>
                </select>
            </div>
            <div class="form-group{{ $errors->has('motor_serie') ? ' has-danger' : '' }}">
                <label class="form-control-label" for="input-motor_serie">{{ __('N° Serie motor') }}</label>
                <input type="text" maxlength="50" name="details[motor_serie]" id="input-motor_serie" class="form-control {{ $errors->has('motor_serie') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese serie de motor') }}" value="" autofocus>
            </div>
            <div class="form-group{{ $errors->has('cylinders') ? ' has-danger' : '' }}">
                ...
                <input type="number" name="details[cylinders]" id="input-cylinders" min="0" max="16" class="form-control {{ $errors->has('cylinders') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese n° de cilindros') }}" value="" autofocus>
            </div>
            <div class="form-group{{ $errors->has('kilometers') ? ' has-danger' : '' }}">
                ...
                <input type="number" name="details[kilometers]" id="input-kilometers" min="0" max="9999999" 
                    ...
                    value="{{ (isset($car) && isset($car->details)) ? (int)$car->details->kilometers:0 }}" autofocus>
            </div>
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('cc') ? ' has-danger' : '' }}">
                    <label class="form-control-label" for="input-cc">{{ __('Cilindrada (cc)') }}</label>
                    <input type="number" name="details[cc]" id="input-cc" min="0" max="5000" class="form-control {{ $errors->has('cc') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese cilindrada') }}" value="" autofocus>
                </div>
                <div class="col-md-6 form-group{{ $errors->has('hp') ? ' has-danger' : '' }}">
                    <label class="form-control-label" for="input-hp">{{ __('Potencia (hp)') }}</label>
                    <input type="number" name="details[hp]" id="input-hp" min="0" max="5000" class="form-control {{ $errors->has('hp') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese potencia') }}" value="" autofocus>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('torque') ? ' has-danger' : '' }}">
                    ...
                    <input type="number" name="details[torque]" id="input-torque" min="0" max="5000" class="form-control {{ $errors->has('torque') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese torque') }}" value="" autofocus>
                </div>
                <div class="col-md-6 form-group{{ $errors->has('doors_number') ? ' has-danger' : '' }}">
                    ...
                    <input type="number" name="details[doors_number]" id="input-doors_number" min="0" max="10" class="form-control {{ $errors->has('doors_number') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese número de puertas') }}" value="" autofocus>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 form-group{{ $errors->has('transmition') ? ' has-danger' : '' }}">
                    ...
                    <select name="details[transmition]" id="input-transmition" class="form-control {{ $errors->has('transmition') ? ' is-invalid' : '' }}" autofocus>
                ...
                <div class="col-md-6 form-group{{ $errors->has('traction') ? ' has-danger' : '' }}">
                    ...
                    <select name="details[traction]" id="input-traction" class="form-control {{ $errors->has('traction') ? ' is-invalid' : '' }}" autofocus>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group{{ $errors->has('work_hours') ? ' has-danger' : '' }}">
                ...
                <input type="number" name="details[work_hours]" id="input-work_hours" min="0" max="9999" class="form-control {{ $errors->has('work_hours') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese horas de trabajo') }}" value="" autofocus>
            </div>
            <div class="form-group{{ $errors->has('ticket_amount_sutran') ? ' has-danger' : '' }}">
                ...
                <input type="number" name="details[ticket_amount_sutran]" id="input-ticket_amount_sutran" class="form-control {{ $errors->has('ticket_amount_sutran') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese monto de papeletas SUTRAN') }}" value="" autofocus>
            </div>
            <div class="form-group{{ $errors->has('ticket_amount_sat') ? ' has-danger' : '' }}">
                ...
                <input type="number" name="details[ticket_amount_sat]" id="input-ticket_amount_sat" class="form-control {{ $errors->has('ticket_amount_sat') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese monto de papeletas SAT') }}" value="" autofocus>
            </div>
            <div class="form-group{{ $errors->has('work_hours') ? ' has-danger' : '' }}">
            ...
            <div class="form-group{{ $errors->has('observations') ? ' has-danger' : '' }}">
                ...
                <input type="text" maxlength="150" name="details[observations]" id="input-observations" class="form-control {{ $errors->has('observations') ? ' is-invalid' : '' }}" placeholder="{{ __('Ingrese observaciones adicionales') }}" value="" autofocus>
            </div>
        </div>
